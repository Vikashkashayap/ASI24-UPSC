...
/** Questions per API call for topic practice — align with Prelims Mock batch size. */

export function getPracticeBatchSize() {

  return Math.max(5, Math.min(20, parseInt(process.env.PRACTICE_BATCH_SIZE, 10) || 10));
