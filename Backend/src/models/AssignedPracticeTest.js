...
/**
 * Admin-assigned topic practice test (50 or 100 questions).
...
const assignedPracticeTestSchema = new mongoose.Schema(
  {
    ...
    /** Free-text topic keyword used for chapter-wide RAG search (optional). */
    searchQuery: {
      type: String,
      default: "",
      trim: true,
    ...
    /** Extra / duplicate / incomplete questions kept after selecting the final set */
    backupQuestions: [
      {
        question: { type: String, required: true },
        question_en: { type: String, required: false },
        ...
        options_en: { type: mongoose.Schema.Types.Mixed, required: false },
        options_hi: { type: mongoose.Schema.Types.Mixed, required: false },
        correctAnswer: { type: String, required: true, enum: ["A", "B", "C", "D"] },
        explanation: { type: mongoose.Schema.Types.Mixed, required: true },
        explanation_en: { type: mongoose.Schema.Types.Mixed, required: false },
        explanation_hi: { type: mongoose.Schema.Types.Mixed, required: false },
        ...
        eliminationLogic: { type: String, required: false },
        conceptualSource: { type: String, required: false },
        backupReason: { type: String, required: false },
      },
    ],
    assignedStudentIds: [
      {
    ...
    generationStats: {
      ...
      /** rag_qdrant | rag_mongo | live_fallback | rag */
      notesSource: { type: String, default: "" },
      ragSources: { type: mongoose.Schema.Types.Mixed, default: {} },
    },
    createdBy: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "User",
