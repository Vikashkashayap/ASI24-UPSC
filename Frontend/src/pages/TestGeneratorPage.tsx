      ...
      <div className={`relative overflow-hidden rounded-2xl p-6 md:p-8 border-2 transition-all duration-300 ${theme === "dark"
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4 md:gap-6">
          ...
          <Button
            ...
            className={`flex items-center gap-2 shadow-lg transition-all duration-300 ${theme === "dark"
          ...
          <form onSubmit={handleGenerate} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                {subjects.map((sub) => (
                  <button
                    ...
                    className={`px-4 py-3 rounded-lg border transition-colors ${subject === sub
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 rounded-lg border focus:ring-2 focus:ring-purple-500 focus:border-transparent ${theme === "dark"
            ...
            <Button
              ...
              className={`w-full px-6 py-4 text-base font-semibold ${isGenerating || !topic.trim()
